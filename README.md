...
| easy4j dependencies | `shiro-biz`, `shiro-jwt-extension`, `dingtalk-sdk-extension` (all `3.0.x.x.20260630-SNAPSHOT`) |
...
```groovy
implementation 'io.github.easy4j:shiro-dingtalk-extension:3.0.x.x.20260630-SNAPSHOT'
```
